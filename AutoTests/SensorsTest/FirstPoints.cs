...
namespace AutoTests.AutoTest.SensorsTest
{
    class FirstPoints
    {
        ...
        /// <summary>
        /// Тест #1. Проверка первого значения сигнала. Если timefrom совпадает со временем первого элемента выборки.
        /// </summary>
        ...
        /// <summary>
        /// Тест #2. Проверка первого значения сигнала. Если timefrom не совпадает со временем первого элемента выборки. Проводим линейную интерполяцию для определения значения.
        /// </summary>
        /// <param name="_TextInformation"></param>
        /// <param name="TimeDemention"></param>
        /// <returns></returns>
