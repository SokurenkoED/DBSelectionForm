...
namespace AutoTests.AutoTest.SensorsTest
{
    class LastPoints
    {
        ...
        /// <summary>
        /// Тест #1. Проверка последнего значения сигнала. После заданного времени нет изменений для заданного сигнала.
        /// Время последнего элемента не совпадает с заданным временем пользователя.
        /// </summary>
        /// <param name="_TextInformation"></param>
        /// <param name="TimeDemention"></param>
        ...
        /// <summary>
        /// Тест #1. Проверка последнего значения сигнала. Если встретился сигнал со временем равным времени timeto, заданным порльзователем
        /// </summary>
        /// <param name="_TextInformation"></param>
        /// <param name="TimeDemention"></param>
        /// <returns></returns>
